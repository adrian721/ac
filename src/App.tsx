...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col font-sans antialiased selection:bg-cyan-500 selection:text-black">
      ...
      {/* Main App Container */}
      <div className="flex-1 flex max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 gap-6 sm:gap-8">
        {/* Sidebar Navigation */}
        <Sidebar 
          activeTab={activeTab} 
      ...
      {/* Footer banner */}
      <footer className="py-4 border-t border-white/10 bg-[#0A0A0A] text-center text-xs text-white/40">
