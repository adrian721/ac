    ...
    <div className="space-y-6">
      ...
      <div className="flex border-b border-slate-800 bg-slate-900/60 p-1.5 rounded-2xl gap-2 overflow-x-auto">
        ...
        >
          ...
          <span>Matrix Hak Akses Per Role ({rolesList.length} Role)</span>
        </button>
        <button
        ...
        >
          ...
          <span>Kontrol Akses Per Anggota (Individual Override)</span>
        </button>
        <button
        ...
        >
          ...
          <span>Kontrol Akun & Reset Kata Sandi</span>
        </button>
      </div>
