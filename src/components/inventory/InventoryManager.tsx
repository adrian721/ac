                ...
                {isSuperOrAdmin && (
                  <div className="pt-2 flex gap-2">
                    <button
                      ...
                      className="w-full py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-black uppercase tracking-wider transition cursor-pointer text-center"
                    >
                      Restok Part Ini
                    </button>
                  </div>
