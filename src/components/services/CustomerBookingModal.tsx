...
export const CustomerBookingModal: React.FC<CustomerBookingModalProps> = ({ onClose, initialAcUnit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-[#0F0F0F] rounded-3xl shadow-2xl overflow-hidden my-8 border border-white/15 text-white">
        ...
        <div className="flex items-center justify-between px-6 py-5 bg-white/5 border-b border-white/10">
          <div>
            ...
            <h3 className="font-black text-2xl tracking-tight text-white leading-tight">PESAN SERVIS AC</h3>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Stepper indicator */}
        <div className="px-6 py-3 bg-black/40 border-b border-white/10 flex items-center justify-between text-xs font-black uppercase tracking-wider">
          <button
            onClick={() => setStep(1)}
