...
export const ServiceOrdersList: React.FC<ServiceOrdersListProps> = ({ onOpenBookingModal }) => {
  const { currentUser, serviceOrders, submitCustomerReview } = useApp();
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-white/10">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-black uppercase tracking-wider transition cursor-pointer"
                    >
